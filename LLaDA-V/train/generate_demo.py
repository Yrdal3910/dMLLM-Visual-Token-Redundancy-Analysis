...
pretrained = "/pfs/zuhaoyang/workspace/cache/LLaDA-V"

model_name = "llava_llada"
device = "cuda:0"
device_map = "cuda:0"
tokenizer, model, image_processor, max_length = load_pretrained_model(pretrained, None, model_name, attn_implementation="flash_attention_2", device_map=device_map)  # Add any other thing you want to pass in llava_model_args

model.eval()
image = Image.open("/pfs/zuhaoyang/workspace/LLaDA-V/train/test.jpg")
