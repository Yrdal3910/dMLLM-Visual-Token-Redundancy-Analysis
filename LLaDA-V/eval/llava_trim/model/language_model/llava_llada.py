    ...
    def generate(
        ...
        **kwargs,
        ...
        if images is not None:
            (inputs, position_ids, attention_mask, _, inputs_embeds, _, image_token_length) = self.prepare_inputs_labels_for_multimodal(inputs, position_ids, attention_mask, None, None, images, modalities, image_sizes=image_sizes, texts=texts)
            image_token_length = torch.tensor(image_token_length, dtype=torch.int)
        else:
            inputs_embeds = self.get_model().embed_tokens(inputs)

        return super().generate_with_embeds(inputs_embeds=inputs_embeds, system_prompt_len=system_prompt_len, image_token_length=image_token_length, **kwargs)
