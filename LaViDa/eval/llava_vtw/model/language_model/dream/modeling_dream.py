...
class DreamSdpaAttention(DreamAttention):
    ...
    def forward(
        ...
        if (
            ...
            and gu.PRUNED_LAYER_NUMS == gu.get_vtw_target_layer_call(self.num_hidden_layers)
            and gu.PRUNED_STEPS_NUMS == gu.VTW_PRUNING_STEP
        ):
        ...
        return attn_output, None, past_key_value, attn_score, position_ids, position_embeddings
...
class DreamFlashAttention2(DreamAttention):
    ...
    def forward(
        ...
        **kwargs,
        ...
        return attn_output, attn_weights, past_key_value, attn_score, position_ids, position_embeddings
...
class DreamDecoderLayer(nn.Module):
    def __init__(self, config: DreamConfig, layer_idx: int):
        ...
        self.self_attn = DreamFlashAttention2(config, layer_idx)
    ...
    def forward(
        ...
        **kwargs,
        ...
        # Self Attention
        hidden_states, self_attn_weights, present_key_value, attn_score, position_ids, position_embeddings = self.self_attn(
            hidden_states=hidden_states,
            prune_num=prune_num,
            attention_mask=attention_mask,
            position_ids=position_ids,
        ...
        if gu.START_COMPRESSION_MODE and gu.is_vtw_pruning_point(
